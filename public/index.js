...
app.controller('QuizController', function ($scope) {
    ...
    $scope.calculateScore = function () {
        ...
        totalScore += optionScores[$scope.answers.q1];
        totalScore += optionScores[$scope.answers.q2];
        totalScore += optionScores[$scope.answers.q3];
        totalScore += optionScores[$scope.answers.q4];
        totalScore += optionScores[$scope.answers.q5];
        totalScore += optionScores[$scope.answers.q6];

        if (totalScore <= 30) {
            window.alert("It is recommended you to take engineering counselling session");
        }
        else{
            window.alert("It is recommended you to take engineering counselling session");
        }
